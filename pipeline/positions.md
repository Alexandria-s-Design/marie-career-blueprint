# Faculty Position Pipeline

## Active Applications
| Institution | Position | Department | Deadline | Status | Link |
|------------|----------|------------|----------|--------|------|
| *(none yet)* | | | | | |
...
| Merced College | Instructional Designer — Faculty (Tenure-Track) | Merced, CA | **Apr 9, 2026 🔴** | HIGH | CA community college; AI-enhanced instruction; $72K-$97K; Innovation Center role |
| Northern Kentucky University | Educational Leadership Faculty (Prof of Practice) | Online Ed.D. | Open until filled | HIGH | Fully online; Ed.D. program; AI + leadership dev framing; review began Feb 27. [Link](https://jobs.chronicle.com/job/37958096/educational-leadership-faculty-professor-of-practice-/) |
| University of Utah | Asst/Assoc Professor — AI and Emerging Technologies in Teaching & Learning | Salt Lake City, UT | Open/Fall 2026 | HIGH | Practitioner backgrounds considered; doctoral ed, instructional design. [Link](https://www.higheredjobs.com/faculty/details.cfm?JobCode=179273184) |
| University of Memphis | Clinical Asst/Assoc Professor — Instructional Design & Technology | Memphis, TN | Open/Aug 2026 | HIGH | Non-TT clinical appt; Dept of Instruction & Curriculum Leadership; practitioner track. [Link](https://www.higheredjobs.com/faculty/details.cfm?JobCode=179292161) |
...
| Institution | Position | Applied Date | Follow-up Date | Status |
|------------|----------|-------------|----------------|--------|
| *(none yet)* | | | | |

## Interviews Scheduled
| Institution | Position | Date | Format | Prep Notes |
|------------|----------|------|--------|------------|
| *(none yet)* | | | | |

## Closed/Rejected
| Institution | Position | Outcome | Notes |
|------------|----------|---------|-------|
| *(none yet)* | | | |

## Position Search Sources
- HigherEdJobs.com — blocked for scraping; search manually
- Chronicle Vitae (jobs.chronicle.com) — blocked for scraping; search manually
- Inside Higher Ed (careers.insidehighered.com) — active daily
- HERC (Higher Education Recruitment Consortium)
- University career portals directly
- LinkedIn — "Professor of Practice Educational Technology"
- Academic Jobs Online (academicjobsonline.org/ajo/AI)
